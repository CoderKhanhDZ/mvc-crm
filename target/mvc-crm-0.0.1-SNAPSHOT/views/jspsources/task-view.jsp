...
<div class="container-fluid">
	<div class="row bg-title">
		...
		<div class="col-lg-9 col-sm-8 col-md-8 col-xs-12 text-right">
			<a
				href="<%=request.getContextPath() + UrlsController.URL_TASK_ADD%>"
			...
			<div class="white-box">
				<div class="table-responsive">
					...
					<div class="col-md-6 text-right">
						...
						<form class="form-inline" method="get">
							<input type="hidden" name="current_page" id="current_page"
								...
								name="keyword_search" aria-controls="editable-sample" required> <input
					...
					<table class="table" id="example">
						...
						<tbody>
							<tr class="">
								<c:forEach var="task" items="${viewTasks}"
									varStatus="loop">
									<tr>
					...
					<nav aria-label="Page navigation example" align="right">
						<ul class="pagination">
							...
							<c:forEach var="i" begin="${current_page}" end="${current_page + 2}">
								<c:choose>
